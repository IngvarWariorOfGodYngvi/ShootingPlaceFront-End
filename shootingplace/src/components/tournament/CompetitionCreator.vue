    ...
    <q-card class="bg-dark text-positive" style="min-width: 65vw; height: 80vh">
        <q-card-section class="col items-center">
          ...
          <div v-if="type">
            ...
            <q-radio v-model="countingMethod" class="q-pl-xs" v-for="(item,index) in countingMethods.filter(f=>f!='IPSC')" :key="index" :val="item" :label="item" color="primary"/>
          </div>
          <div v-if="!type">
            <b>Metoda Liczenia</b><br/>
          ...
          <div>
            <b>Nazwa Konkurencji</b><div v-if="stop" @click="stop=!stop" class="text-caption hover1">przywróć edytowanie</div><br/>
        ...
        <q-card-section>
          <div>
            <q-btn color="primary" label="zapisz" @click="createCompetition()" v-close-popup/>
