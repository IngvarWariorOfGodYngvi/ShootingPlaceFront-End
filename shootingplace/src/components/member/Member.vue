  ...
  <div v-if="member != null" style="min-width: 75vw">
      ...
      <q-card-section
        ...
        <div class="col q-pa-xs">
          ...
          <div v-if="member.imageUUID != null">
            <q-btn glossy color="primary" label="zmień zdjęcie" dense rounded>
          ...
          <div>
            <q-btn glossy color="primary" label="dodaj notatkę" dense rounded class="q-mt-xs">
              <q-popup-edit value="" content-class="bg-dark text-positive rounded" @hide="note = null">
                <div class="text-h6 text-center text-positive">Dodaj notatkę dla Klubowicza</div>
                <div class="text-center text-positive">Notatka będzie widoczna również dla Klubowicza </div>
                <q-input autofocus v-model="note" dense rounded standout="" label="Notatka dla Klubowicza" input-class="text-white" label-color="white" bg-color="primary" style="min-width: 40vw"/>
                <q-card-actions align="right">
                  <q-btn @click="addNote(member.uuid, note)" glossy label="dodaj notatkę" color="primary" class="q-mt-xs" rounded v-close-popup/>
                  <q-btn @click="addNote(member.uuid, null)" glossy label="usuń notatkę" color="red" class="q-mt-xs" rounded v-close-popup/>
                </q-card-actions>
              </q-popup-edit>
            </q-btn>
          </div>
        ...
        <div class="col text-bold q-pa-xs">
          ...
          <q-item-label v-if="member.note != null">Notatka: {{ member.note }}</q-item-label>
        </div>
        ...
        <div class="col-5 text-center">
          ...
          <q-expansion-item dense v-if="!member.erased && main && !mobile"
            ...
            <q-expansion-item dense v-if="!member.erased"
              ...
              <q-item dense>
              <q-btn glossy class="col" color="primary" rounded dense v-if="member.shootingPatent.patentNumber !== null"
              ...
              <q-btn glossy class="col" color="primary" v-else label="DODAJ PATENT"
              ...
              <q-item v-if="
                ...
                <div class="text-center full-width self-center">Klubowicz posiada cały Patent</div>
              </q-item>
            </q-expansion-item>
            <q-expansion-item dense v-if="member.adult && !member.erased"
              ...
              <q-item dense>
                <q-input dense @keypress.enter="changeWeaponPermission(member.uuid, weaponPermissionNumber, isExist)"
                  rounded standout="" class="col" bg-color="grey-3" label-color="black" input-class="text-black"
                ...
                <q-btn glossy rounded dense class="col" v-if="!member.weaponPermission.exist" label="Dodaj"
                  color="primary" @click=" changeWeaponPermission(member.uuid, weaponPermissionNumber, isExist)" />
                <q-btn glossy rounded dense class="col" v-if="member.weaponPermission.exist" label="Usuń pozwolenie"
            ...
            <q-expansion-item dense v-if="member.adult && !member.erased"
              ...
              group="right-right-card" icon="list">
              <q-item dense>
                <q-input dense rounded standout=""
                  @keypress.enter=" changeWeaponAdmission(member.uuid, admissionToPossess, admissionToPossessIsExist)"
                  class="col" bg-color="grey-3"
                  v-if="member.weaponPermission.admissionToPossessAWeapon == null || !member.weaponPermission.admissionToPossessAWeaponIsExist"
                  v-model="admissionToPossess" label="Numer Dopuszczenia" />
                <q-btn glossy rounded dense class="col round" v-if="!member.weaponPermission.admissionToPossessAWeaponIsExist"
            ...
            <q-expansion-item dense v-if="member.adult && !member.erased" label="Uprawnienia"
              ...
              <q-expansion-item dense
                ...
                <q-item dense>
                  <q-input dense @keypress.enter=" memberUUID = member.uuid; shootingLeaderConfirm = true" rounded standout="" input-class="text-black" label-color="black"
                    class="col" bg-color="grey-3" v-model="permissionsShootingLeaderNumber" label="Numer Uprawnień"/>
                  <q-btn glossy rounded dense class="col" label="Dodaj" color="primary"
              ...
              <q-expansion-item dense
                ...
                group="qualifications" icon="arrow_forward">
                <q-item dense>
                  <q-input dense @keypress.enter=" memberUUID = member.uuid; instructorConfirm = true"  rounded standout="" input-class="text-black" label-color="black"
                    class="col" v-model="permissionsInstructorNumber" label="Numer Uprawnień" bg-color="grey-3" />
                  <q-btn glossy rounded dense class="col"
              ...
              <q-expansion-item dense v-if="member.adult && !member.erased"
                ...
                group="qualifications" icon="arrow_forward">
                <q-item dense>
                  <q-input dense rounded standout="" class="col" label-color="black" input-class="text-black" bg-color="grey-3"
                    v-if="member.memberPermissions.arbiterNumber == null || member.memberPermissions.arbiterNumber === ''"
                    v-model="permissionsArbiterNumber" label="Numer Uprawnień"/>
                  <q-input  dense rounded standout="" class="col" label-color="black" input-class="text-black" v-model="permissionsArbiterPermissionValidThru"
                  ...
                  <q-btn glossy dense rounded class="col" v-if="member.memberPermissions.arbiterNumber != null"
                ...
                <div class="col">
                  ...
                  <q-item dense v-if="member.memberPermissions.arbiterNumber !== null" class="full-width row">
                    <q-input dense rounded standout="" class="col" bg-color="grey-3" label-color="black" input-class="text-black"
                      v-if="member.memberPermissions.arbiterNumber != null" v-model="permissionsArbiterNumber"
                      label="Numer Uprawnień" />
                    <q-btn glossy dense class="col" rounded
            ...
            <q-expansion-item dense v-if="!member.erased && shootingPlace === 'prod'" label="Deklaracja LOK"
              ...
              <q-item dense>
                <q-btn glossy dense text-color="black" rounded class="col"
            ...
            <q-expansion-item dense label="Dodaj Kartę" group="right-right-card" icon="credit_card">
              <q-item dense>
                <q-input @keypress.enter="addCard = true" v-model="cardNumber" rounded standout="" input-class="text-black" label-color="black" class="col" bg-color="grey-3" dense label="wprowadź numer karty"/>
                <q-btn @click="addCard = true" class="col" dense rounded label="dodaj" text-color="white" color="primary"/>
              </q-item>
            ...
            <q-expansion-item dense label="Zmień klub macierzysty" @click=" getAllClubs()" class="text-center"
              icon="swap_horiz">
              <div class="text-left">
                <q-checkbox :value="clubChoiceToggle" v-model="clubChoiceToggle" keep-color
                ...
                <q-select v-if="clubChoiceToggle" dense options-dense bg-color="grey-3" :options="clubs" emit-value
                  ...
                  popup-content-class="bg-dark text-positive" v-model="clubChoice" rounded standout="" fill-input
                  label="wybierz Klub">
                ...
                <q-btn glossy dense rounded v-if="clubChoice !== '' && clubChoiceToggle" class="full-width round"
        ...
        <div :class="mobile ? 'col bg-dark text-positive' : 'row full-width bg-dark text-positive'">
          ...
          <div v-if="!member.erased && main && !mobile" class="col-5">
            <q-item-section class="col full-width">
              <q-item dense class="q-pb-xs" v-if="shootingPlace === 'prod'">
              ...
              <q-item dense v-if="member.history.contributionList.length > 0" class="q-pb-xs">
              ...
              <q-item dense v-if="!member.erased" class="q-pb-xs">
                <q-tooltip v-if="member.club.id !== 1" content-class="text-h6 bg-red" anchor="top middle"
                  self="bottom middle" :offset="[12, 12]">INNY KLUB MACIERZYSTY
                </q-tooltip>
    ...
    <q-dialog v-model="contribution">
      <q-card class="bg-dark text-positive">
        ...
        <q-card-actions align="center">
          ...
          <q-btn glossy label="przedłuż" color="primary" v-close-popup @click=" contributionCode = true" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    ...
    <q-dialog v-model="addressConfirm">
      <q-card class="bg-dark text-positive">
        <q-card-section class="col items-center">
          ...
          <q-item>
            <q-input v-model="memberStreetNumber" label-color="positive" input-class="text-positive"
              label="Numer Ulicy" />
          </q-item>
          <q-item>
            <q-input v-model="memberFlatNumber" label-color="positive" input-class="text-positive"
    ...
    <q-dialog v-model="addressConfirm1">
      <q-card class="bg-dark text-positive">
        ...
        <q-card-actions align="right">
          <q-btn glossy label="anuluj" color="secondary" v-close-popup />
          <q-btn glossy label="zmień" color="primary" v-close-popup @click=" updateMemberCode = true" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    <q-dialog v-model="updateMemberCode" persistent>
      <q-card class="bg-red-5 text-center">
        <q-card-section class="flex-center">
          <h3><span class="q-ml-sm">Wprowadź kod potwierdzający</span></h3>
          <q-input
            @keypress.enter="updateIDCardAndName(memberUUID, memberIdCard, memberFirstName, memberSecondName, code); updateMember(memberUUID, memberEmail, memberPhoneNumber, code);
            updateAddress(memberUUID, memberZipCode, memberPostOfficeCity, memberStreet, memberStreetNumber, memberFlatNumber, code); updateMemberCode = false"
            autofocus type="password" v-model="code" filled color="Yellow" class="bg-yellow text-bold"
            mask="####"></q-input>
        </q-card-section>
        ...
        <q-card-actions align="right">
          <q-btn glossy label="anuluj" color="black" v-close-popup @click=" code = null" />
          <q-btn glossy label="Przenieś" color="black" v-close-popup
            @click="updateIDCardAndName(memberUUID, memberIdCard, memberFirstName, memberSecondName, code), updateMember(memberUUID, memberEmail, memberPhoneNumber, code);
    ...
    <q-dialog v-model="pzssPortal">
      <q-card class="bg-dark text-positive">
        ...
        <q-card-actions align="center">
          <q-btn glossy label="nie" color="secondary" v-close-popup @click=" togglePzss(memberUUID, false)" />
          <q-btn glossy label="tak" color="primary" v-close-popup @click=" togglePzss(memberUUID, true)" />
          <q-btn glossy label="anuluj" color="secondary" v-close-popup />
        </q-card-actions>
      </q-card>
    </q-dialog>
    <q-dialog v-model="declarationLOK">
      <q-card class="bg-dark text-positive">
        ...
        <q-card-actions align="center">
          <q-btn glossy label="nie" color="secondary" v-close-popup @click=" toggleDeclarationLOK(memberUUID, false)" />
          <q-btn glossy label="tak" color="primary" v-close-popup @click=" toggleDeclarationLOK(memberUUID, true)" />
          <q-btn glossy label="anuluj" color="secondary" v-close-popup />
        </q-card-actions>
      </q-card>
    </q-dialog>
    <q-dialog v-model="basicDataConfirm">
      <q-card class="bg-dark text-positive">
        <q-card-section class="col items-center">
          ...
          <q-item>
            <q-input v-model="memberIdCard" label-color="positive" input-class="text-positive"
    ...
    <q-dialog v-model="basicDataConfirm1">
      <q-card class="bg-dark text-positive">
        ...
        <q-card-actions align="center">
          <q-btn glossy label="anuluj" color="secondary" v-close-popup />
          <q-btn glossy label="zapisz" color="primary" v-close-popup @click=" updateMemberCode = true" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    <q-dialog v-model="deactivate">
      <q-card class="bg-dark text-positive">
        ...
        <q-card-actions align="center">
          <q-btn glossy label="anuluj" color="secondary" v-close-popup />
          <q-btn glossy label="przenieś" color="primary" v-close-popup @click=" activeCode = true" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    ...
    <q-dialog v-model="backConfirm">
      <q-card class="bg-dark text-positive">
        ...
        <q-card-actions align="center">
          <q-btn glossy label="anuluj" color="secondary" v-close-popup />
          <q-btn glossy label="przywróć" color="primary" v-close-popup @click=" activeCode = true" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    <q-dialog v-model="activeCode" persistent>
      <q-card class="bg-red-5 text-center">
        <q-card-section class="flex-center">
          <h3><span class="q-ml-sm">Wprowadź kod potwierdzający</span></h3>
          <q-input @keypress.enter=" changeActive(memberUUID); activeCode = false" autofocus type="password"
            v-model="code" filled color="Yellow" class="bg-yellow text-bold" mask="####"></q-input>
        </q-card-section>
    ...
    <q-dialog v-model="eraseWeapon">
      <q-card>
        ...
        <q-card-actions align="center">
          <q-btn glossy label="anuluj" color="secondary" v-close-popup />
          <q-btn glossy label="usuń" color="primary" v-close-popup @click=" removeWeaponPermissionOrAdmission()" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    ...
    <q-dialog v-model="arbiterUpdateClassConfirm"
      ...
      <q-card>
        ...
        <q-card-actions align="center">
          <q-btn glossy label="anuluj" color="secondary" v-close-popup />
          <q-btn glossy label="podnieś" color="primary" v-close-popup @click=" updateMemberArbiterClass(memberUUID)" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    <q-dialog v-model="eraseConfirm" @keypress.enter=" eraseCode = true; eraseConfirm = false">
      <q-card class="bg-warning">
        <q-card-section class="row">
          <span class="q-ml-sm text-h6 text-bold text-center">Czy na pewno chcesz usunąć Klubowicza <br />z listy
            członków
            klubu?</span>
        </q-card-section>

        <q-card-actions align="center">
          <q-btn glossy label="anuluj" color="white" text-color="black" v-close-popup />
          <q-btn glossy label="usuń" color="red" text-color="black" v-close-popup @click=" eraseCode = true" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    <q-dialog v-model="eraseCode" persistent>
      <q-card class="bg-red-5 text-center">
        <q-card-section class="flex-center">
          <h3><span class="q-ml-sm">Wprowadź kod potwierdzający</span></h3>
          <q-input @keypress.enter=" eraseMember(memberUUID); eraseCode = false" autofocus type="password"
            v-model="code" filled color="Yellow" class="bg-yellow text-bold" mask="####"></q-input>
        </q-card-section>

        <q-card-actions align="right">
          <q-btn glossy label="anuluj" color="black" v-close-popup @click=" code = null" />
          <q-btn glossy label="skreśl" color="black" v-close-popup @click=" eraseMember(memberUUID); code = null" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    ...
    <q-dialog v-model="changeAdultCode" persistent>
      <q-card class="bg-red-5 text-center">
        ...
        <q-card-actions align="right">
          <q-btn glossy text-color="white" label="anuluj" color="black" v-close-popup @click=" code = null" />
          <q-btn glossy text-color="white" label="Przedłuż" color="black" v-close-popup
    ...
    <q-dialog v-model="contributionDownloadConfirm"
      ...
      <q-card class="bg-dark text-positive">
        ...
        <q-card-actions align="center">
          <q-btn glossy label="anuluj" color="secondary" v-close-popup />
          <q-btn glossy label="Pobierz" color="primary" v-close-popup @click=" getContributionPDF()" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    <q-dialog v-model="addAmmoConfirm" @keypress.enter="showloading(); simulateProgress1(); addAmmoConfirm = false">
      <q-card class="bg-dark text-positive">
        ...
        <q-card-actions align="center">
          <q-btn glossy label="anuluj" color="secondary" v-close-popup />
          <q-btn glossy label="wydaj" color="primary" v-close-popup @click="showloading(); simulateProgress1()" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    <q-dialog v-model="patentConfirm">
      <q-card class="bg-dark text-positive">
        ...
        <q-card-section>
          <div class="col">
            <div class="row">
              <q-input input-class="text-positive" label-color="positive" color="positive" filled dense
                label="numer patentu" v-model="patentNumber" mask="######"></q-input>
              <div class="col-1 self-center">/PAT/</div>
              <q-input input-class="text-positive" label-color="positive" color="positive" filled dense
                label="miesiąc / rok" v-model="patentNumber1" mask="##/####"></q-input>
            </div>
            <q-input class="col" input-class="text-positive" label-color="positive" color="positive" filled dense
              v-model="patentDate" mask="####-##-##" label="Wybierz datę">
              <template v-slot:append>
        ...
        <q-card-actions align="right">
          <q-btn glossy label="anuluj" color="secondary" v-close-popup />
          <q-btn glossy label="Dodaj" color="primary" v-close-popup @click=" patentConfirm1 = true" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    ...
    <q-dialog v-model="contributionRemoveRecordQuery"
      ...
      <q-card class="bg-red-5 text-center">
        ...
        <q-card-actions align="center">
          <q-btn glossy label="anuluj" color="black" v-close-popup />
          <q-btn glossy label="Usuń" color="black" v-close-popup @click=" contributionRemoveRecordQueryCode = true" />
        </q-card-actions>
      </q-card>
    </q-dialog>
          ...
          <div v-for="(item, index) in test" :key="index" class="full-width">
            ...
            <div v-for="(item1, index1) in item.scoreList" :key="index1" class="text-left row full-width">
              <div class="full-width row" v-if="item1.member != null"
                :style="item1.member.uuid === member.uuid ? 'padding-left: 1em; padding-right: 1em;' : ''"
                :class="item1.member.uuid === member.uuid ? 'bg-warning round' : ''">
    ...
    <q-dialog v-model="contributionRemoveRecordQueryCode" persistent>
      <q-card class="bg-red-5 text-center">
        ...
        <q-card-actions align="right">
          <q-btn glossy label="anuluj" color="black" v-close-popup @click=" code = null" />
          <q-btn glossy label="Usuń" color="black" v-close-popup @click=" removeContributionRecord()" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    ...
    <q-dialog v-model="editContribution" @keypress.esc=" editContribution = false">
      <q-card class="bg-dark text-positive">
        ...
        <q-card-section>
          <div class="row">
            <q-input class="col-6" dense v-model="editContributionPaymentDate" input-class="text-positive"
              label-color="positive" filled standout="bg-accent text-black" stack-label mask="####-##-##"
              label="Data Opłacenia Składki">
              <template v-slot:append>
                <q-icon name="event" class="cursor-pointer" color="positive">
                  <q-popup-proxy ref="qDateProxy" transition-show="scale" transition-hide="scale">
            ...
            <q-input class="col-6" dense v-model="editContributionValidThruDate" input-class="text-positive"
              label-color="positive" filled standout="bg-accent text-black" stack-label mask="####-##-##"
              label="Ważność Sładki">
              <template v-slot:append>
                <q-icon name="event" class="cursor-pointer" color="positive">
                  <q-popup-proxy ref="qDateProxy" transition-show="scale" transition-hide="scale">
          ...
          <div class="row full-width">
            <div class="col-6 q-pa-md">
              <q-btn glossy dense class="full-width" label="usuń Składkę" color="red"
...
export default {
  ...
  components: {
    ...
    ExtensionApplicationFile: lazyLoadComponent({
      componentFactory: () => import('src/components/member/DownloadExtensionApplicationFile.vue'),
      loading: SkeletonBox
    }),
    CertificateFile: lazyLoadComponent({
      componentFactory: () => import('src/components/member/DownloadCertificateOfMembership.vue'),
      loading: SkeletonBox
    }),
  ...
  methods: {
    ...
    addNote (uuid, note) {
      fetch(`${this.local}/member/note?uuid=${uuid}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
