<template>
  <div class="full-width rounded">
    <q-btn glossy class="full-width" @click="dialog=true" color="secondary">Pobierz kartę Członkowską Klubu
    ...
    <q-dialog v-model="dialog" @keypress.enter="dialog=false;getPersonalCardPDF()">
      <q-card class="bg-dark text-positive">
        ...
        <q-card-actions align="right">
          ...
          <q-btn glossy text-color="white" label="Pobierz" color="primary" v-close-popup @click="loading=true;getPersonalCardPDF()" />
        </q-card-actions>
      </q-card>
    </q-dialog>
