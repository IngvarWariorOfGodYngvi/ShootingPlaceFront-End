...
export default {
  ...
  data () {
    return {
      ...
      ammoList: { ammoInEvidenceDTOList: [], forceOpen: false },
      ammoListClose: [],
      date: '',
      message: null,
      success: false,
