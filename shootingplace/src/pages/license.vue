<template>
  <q-page padding>
          <q-card>
            <q-card-section>
          <div class="q-pa-md text-center col full-width no-outline text-h5 text-bold" >Lista osób z licencjami NIEWAŻNYMI - ilość osób {{quantity[0]}}</div>
            <q-scroll-area class="q-pa-none" style="height: 600px;">
            <ol>
            <li v-for="member in members2" :key="member">
              <div class="row">
          ...
          <q-card>
            <q-card-section>
          <div class="q-pa-md text-center col full-width no-outline text-h5 text-bold" >Lista osób z licencjami AKTUALNYMI  - ilość osób {{quantity[1]}}</div>
            <q-scroll-area class=" q-pa-none" style="height: 600px;">
              <ol>
